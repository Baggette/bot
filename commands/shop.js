  ...
  module.exports={
    ...
    execute(client, message, args){
        if(args[0] === "help"){
            ...
            .addFields(
                {name:"`b!shop add <item name> <price> <message(optional)> <description(optional)> <amount of items to stock(optional)> <role(optional)>`", value:"Adds an item to the shop"},
                {name:"`b!shop remove <item name>`", value:"Removes an item from the shop"},
                {name:"`b!shop buy <item name>`", value:"Buy a desired item from the shop"},
                {name:"`b!shop search <item name>`", value:"Search for an item in the shop"},
                {name:"`b!shop clear`", value:"Clears the entire shop (deletes all items)"},
                {name:"`b!shop inventory`", value:"See all items in your inventory"},
                {name:"`b!shop use <item name>`", value:"Use a specfied item in your inventory"},
                {name:"`b!shop clear inventory`", value:"Removes all items in your inventory **Run this command at your own risk. Items will not be restored!**"},
                {name:"`b!shop history`", value:"See your purchase history"},
                {name:"`b!shop clear history`", value:"Clear your purchase history"},
            )
            .setTimestamp()
