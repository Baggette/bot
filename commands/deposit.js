...
const eco = new Economy({
  ...
  module.exports={
    ...
    execute(client, message, args){
        ...
        .setColor('Yellow')
        .setTitle(`Man you poor mf you don't have enough money in your balance to deposit **${amount}** coins to your bank`) //this line is gold
        .setTimestamp
        ...
        .setColor('Yellow')
        .setTitle(`Successfully deposited **${amount}** coins`)
        .setTimestamp()
